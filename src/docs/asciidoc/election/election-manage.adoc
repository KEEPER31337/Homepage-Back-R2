...
include::{snippets}/register-candidate/http-request.adoc[]

==== Request Cookies

include::{snippets}/register-candidate/request-cookies.adoc[]

==== Path Parameters

include::{snippets}/register-candidate/path-parameters.adoc[]

==== Request Fields

include::{snippets}/register-candidate/request-fields.adoc[]

=== 응답

==== Response

include::{snippets}/register-candidate/http-response.adoc[]
