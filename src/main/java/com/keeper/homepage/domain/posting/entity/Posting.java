...
public class Posting {
  ...
  private Posting(String title, String content, Member member, Integer visitCount,
    ...
    this.allowComment = allowComment != null ? allowComment : true;
    this.isNotice = isNotice != null ? isNotice : true;
    this.isSecret = isSecret != null ? isSecret : true;
    this.isTemp = isTemp != null ? isTemp : true;
