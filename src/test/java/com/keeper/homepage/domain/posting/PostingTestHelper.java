  ...
  public final class PostingBuilder {
    ...
    public Posting build() {
      return postingRepository.save(Posting.builder()
          ...
          .visitCount(visitCount != null ? visitCount : 1)
          .likeCount(likeCount != null ? likeCount : 1)
          .dislikeCount(dislikeCount != null ? dislikeCount : 1)
          .commentCount(commentCount != null ? commentCount : 1)
          .ipAddress(ipAddress != null ? ipAddress : "0.0.0.0")
          .allowComment(allowComment != null ? allowComment : true)
          .isNotice(isNotice != null ? isNotice : true)
          .isSecret(isSecret != null ? isSecret : true)
          .isTemp(isTemp != null ? isTemp : true)
          .password(password)
